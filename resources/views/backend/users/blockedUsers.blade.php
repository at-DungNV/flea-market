...
@section('content')
    ...
    <div class="x_panel">
      ...
      <div class="x_content">
        ...
        <div class="table-responsive">
          <table class="table table-striped jambo_table check-action" id="admin-user-blocked-table">
            <thead>
              <tr class="headings">
                <th>
            ...
            <tbody>
              ...
              <tr class="{{ $key % 2 == 0 ? 'even' : 'odd' }} pointer">
                ...
                <td class="last">
                  ...
                  @if ($user->is_active == 1)
                  <a data-toggle="modal" data-target="#confirm-deleting" class="btn btn-danger btn-lock btn-xs admin-user-blocked-delete">
  ...
  <script type="text/javascript">
    $('#admin-user-blocked-table').DataTable({
      fixedHeader: true
    });
    $(document).ready(function() {
        $(document).on('click',".admin-user-blocked-delete", function() {
