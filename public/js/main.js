...
$(document).ready(function() {
  ...
  $("#wrapper-header").delay(1).animate({opacity:'1',width:'100%'},500);
  $("#wrapper-navbar").delay(1).animate({opacity:'1',height:'60px'},500);
  $("#main-container-image").delay(1).animate({opacity:'1'},500);
